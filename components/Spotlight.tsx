        ...
        <section className="bg-navy-950 text-white overflow-hidden">
            <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-12 md:p-20 flex flex-col justify-center">
                    ...
                    <p className="text-xl text-gray-300 font-light mb-10 leading-relaxed max-w-lg">
                ...
                <div className="relative h-[500px] lg:h-auto group cursor-pointer">
                    <img
                    ...
                    <div className="absolute bottom-0 left-0 p-12 w-full bg-gradient-to-t from-navy-950/90 to-transparent">
                        <span className="text-xs font-bold tracking-widest text-blue-400 uppercase mb-2 block">Featured Report</span>
                        <h3 className="text-3xl font-serif font-medium leading-snug mb-4 group-hover:text-blue-300 transition-colors">
